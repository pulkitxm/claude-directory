...
// Integration note: the verbatim paste used `import React, { ... }`, but with
// Vite's automatic JSX runtime + `noUnusedLocals` the default `React` binding is
// unused and fails the strict build. Dropping it is the only change to the
// shader component; every hook and the shader sources are byte-for-byte intact.
