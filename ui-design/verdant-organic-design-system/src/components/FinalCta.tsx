...
export function FinalCta() {
  ...
  return (
    <section className="relative overflow-hidden bg-secondary px-4 py-32 text-secondary-foreground sm:px-6 lg:px-8">
      ...
      <div aria-hidden className="pointer-events-none absolute -left-24 -top-10 h-96 w-96 rounded-full bg-white/10 blur-3xl" />
      <div aria-hidden className="pointer-events-none absolute -bottom-20 -right-16 h-[26rem] w-[26rem] rounded-full bg-primary/30 blur-3xl" />
      {/* swaying leaf motif */}
      <Leaf
        aria-hidden
        size={120}
