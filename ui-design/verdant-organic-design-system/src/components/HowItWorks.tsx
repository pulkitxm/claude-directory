...
export function HowItWorks() {
  return (
    <section id="how" className="relative overflow-hidden bg-accent/30 px-4 py-32 sm:px-6 lg:px-8">
      <div className="relative mx-auto max-w-6xl">
        <SectionHeading
          eyebrow="From field to cup"
          title={
            <>
              Four slow steps, <span className="italic text-primary">no shortcuts.</span>
            </>
          }
        ...
        <div className="relative mt-20">
          ...
          <ol className="relative grid gap-10 sm:grid-cols-2 lg:grid-cols-4 lg:gap-6">
            {steps.map((s, i) => {
              ...
              return (
                <Reveal key={s.number} delay={i * 0.12} as="li" className="h-full">
