...
export function Pricing() {
  ...
  return (
    <section id="pricing" className="relative overflow-hidden px-4 py-32 sm:px-6 lg:px-8">
      <Blob shape={1} color="bg-accent/40" className="left-1/2 top-10 h-[26rem] w-[26rem] -translate-x-1/2" animate={!reduced} />
      ...
      <div className="relative mx-auto max-w-7xl">
        <SectionHeading
          ...
          title={
            <>
              Steep at your own <span className="italic text-primary">pace.</span>
            </>
          }
              ...
              <Reveal key={plan.name} delay={i * 0.1} className="h-full">
                ...
                >
                      ...
                      <li key={perk} className="flex items-start gap-3">
                        ...
                        <span
                          className={cn(
                            ...
                            highlighted ? "text-primary-foreground/90" : "text-foreground/85",
                          )}
                        >
                          {perk}
                        </span>
                  ...
                  <Button
                    ...
                    className={cn(
                      "mt-8 w-full",
                      highlighted && "bg-card text-foreground hover:bg-background",
                    )}
                  >
                    {plan.cta}
                  </Button>
