...
const columns = [
  {
    title: "Apothecary",
    links: ["All blends", "Morning teas", "Evening tonics", "Seasonal & rare", "Gift tins"],
  },
  {
    title: "The house",
    links: ["Our story", "Foraging journal", "Stewardship pledge", "Stockists", "Visit the table"],
  },
  {
    title: "Care",
    links: ["Brewing notes", "Shipping & returns", "Refill a tin", "Contact us", "FAQ"],
  },
];
      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mt-16 flex flex-col items-center justify-between gap-4 border-t border-border/60 pt-8 sm:flex-row">
          <p className="text-sm font-semibold text-muted-foreground">
            © {new Date().getFullYear()} {brand.name} Apothecary. Shaped by hand.
          </p>
