...
export function Hero() {
  ...
  return (
    <section id="top" className="relative overflow-hidden px-4 pb-24 pt-16 sm:px-6 sm:pt-20 lg:px-8">
      {/* ambient blobs */}
      <Blob shape={1} color="bg-primary/20" className="-left-24 top-10 h-[28rem] w-[28rem]" animate={!reduced} />
      <Blob shape={2} color="bg-secondary/20" className="-right-20 top-40 h-[26rem] w-[26rem]" animate={!reduced} />
      <Blob shape={3} color="bg-accent/50" className="bottom-0 left-1/3 h-72 w-72" animate={!reduced} />
      ...
      <div className="relative mx-auto grid max-w-7xl items-center gap-12 lg:grid-cols-2 lg:gap-8">
        ...
        >
          ...
          <div className="absolute -left-2 top-10 rounded-2xl border border-border/60 bg-card/90 px-4 py-2.5 shadow-soft backdrop-blur-sm sm:-left-6">
            <p className="text-xs font-bold uppercase tracking-wider text-secondary">Whole leaf</p>
            <p className="font-serif text-base font-semibold text-foreground">No dust, ever</p>
          </div>
          <div className="absolute -right-1 bottom-14 rounded-2xl border border-border/60 bg-card/90 px-4 py-2.5 shadow-soft backdrop-blur-sm sm:-right-4">
            <p className="text-xs font-bold uppercase tracking-wider text-secondary">Returns to soil</p>
            <p className="font-serif text-base font-semibold text-foreground">100% compostable</p>
          </div>
        </motion.div>
      </div>
    </section>
