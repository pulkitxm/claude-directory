...
export function Features() {
  ...
  return (
    <section id="features" className="relative overflow-hidden px-4 py-32 sm:px-6 lg:px-8">
      <Blob shape={1} color="bg-accent/40" className="-right-32 top-20 h-[24rem] w-[24rem]" animate={!reduced} />
      <Blob shape={3} color="bg-primary/10" className="-left-28 bottom-10 h-80 w-80" animate={!reduced} />
      ...
      <div className="relative mx-auto max-w-7xl">
        ...
        <div className="mt-16 grid gap-8 md:grid-cols-2 lg:grid-cols-3">
          {features.map((f, i) => {
            ...
            return (
              <Reveal key={f.title} delay={(i % 3) * 0.1} className="h-full" as="div">
                <article
