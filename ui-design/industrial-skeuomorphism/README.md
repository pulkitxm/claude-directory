# SCHEMATIC — Industrial Skeuomorphism

A full landing-page showcase that expresses the **Industrial Skeuomorphism**
design system end to end. SCHEMATIC is a fictional machined control plane for
hardware fleets, and the UI is built to *feel* like the machines it runs:
matte-plastic chassis, neumorphic light-and-shadow, safety-orange controls, and
manufacturing details everywhere (corner screws, vent slots, LED status lamps,
CRT scanlines, push pins, masking tape, punched price-tag holes).
