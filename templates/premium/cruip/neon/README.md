# Neon: Dark-Mode SaaS Landing Page and Auth Flow Template Clone

[![Watch Demo](./poster.jpg)](./demo.mp4)

A pixel-faithful, self-contained HTML, CSS, and JavaScript clone of the **Neon** dark-mode SaaS landing page template by [Cruip](https://cruip.com/demos/neon/). It includes the complete marketing page and matching sign in, sign up, and reset password flows as plain static files with zero build steps.
...
- **Alpine.js** for the interactive resource filters
...
ls templates/premium/cruip/neon/css/
ls templates/premium/cruip/neon/js/
ls templates/premium/cruip/neon/images/
ls templates/premium/cruip/neon/fonts/
...
- [Alpine.js](https://alpinejs.dev/), vendored locally for resource filter interactivity
- [AOS (Animate On Scroll)](https://michalsnik.github.io/aos/), vendored locally and initialized with `once: true`, `duration: 500`, and `easing: 'ease-out-cubic'`
