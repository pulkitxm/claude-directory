...
!(function (e, t) {
	...
	C("H", ["HH", 2], 0, "hour"),
		...
		C("hmmss", 0, 0, function () {
			return "" + $e.apply(this) + T(this.minutes(), 2) + T(this.seconds(), 2);
		}),
		C("Hmm", 0, 0, function () {
	...
	function Dt(e, t, n, r, o) {
		...
		return (
			...
			(l._f = t),
			(l._strict = r),
			(u = new p(ot(Mt(l))))._nextDay && (u.add(1, "d"), (u._nextDay = void 0)),
			u
		);
	}
	function St(e, t, n, s) {
	...
	function Tt(e) {
		...
		(this._isValid = (function (e) {
			var t,
				...
				i = xt.length;
			for (t in e)
				if (r(e, t) && (-1 === pe.call(xt, t) || (null != e[t] && isNaN(e[t]))))
					return !1;
			for (n = 0; n < i; ++n)
				if (e[xt[n]]) {
					if (s) return !1;
	...
	function Ht(e, t) {
		...
		return t._isUTC
			? ((s = t.clone()),
				(i = (v(e) || l(e) ? e.valueOf() : St(e).valueOf()) - s.valueOf()),
								...
								: "object" == typeof a &&
									...
									((i = (function (e, t) {
										...
										(t = Ht(t, e)),
											e.isBefore(t)
												? (n = At(e, t))
												: (((n = At(t, e)).milliseconds = -n.milliseconds),
													(n.months = -n.months));
										return n;
									})(St(a.from), St(a.to))),
									((a = {}).ms = i.milliseconds),
	...
	(kn.calendar = function (e, t, n) {
		...
		(kn.months = function (e, t) {
			return e
				? s(this._months)
					...
					: this._months[
							(this._months.isFormat || De).test(t) ? "format" : "standalone"
						][e.month()]
				: s(this._months)
					? this._months
		...
		(kn.monthsShortRegex = function (e) {
			return this._monthsParseExact
				...
				: (r(this, "_monthsShortRegex") || (this._monthsShortRegex = Se),
		...
		(kn.weekdaysMinRegex = function (e) {
			return this._weekdaysParseExact
				...
				: (r(this, "_weekdaysMinRegex") || (this._weekdaysMinRegex = Ie),
