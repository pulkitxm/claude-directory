...
1. **Header**: Absolute navigation with logo, sign-in link, and primary CTA
2. **Hero**: Centered headline, dual CTAs, and dashboard screenshot
...
5. **Features Tabs**: Tabbed content box switching between Everyone / Freelancers / Organizations via Alpine.js
...
11. **Footer**: Responsive account links with social icons and legal links

## Interactions

- **Pricing toggle**: checkbox switches prices between monthly and yearly rates
- **Feature tabs**: Alpine.js tab switcher with active state styling
...
- [Swiper](https://swiperjs.com/) vendored locally
- [AOS](https://michalsnik.github.io/aos/) vendored locally
- Alpine.js vendored locally for pricing and tab switching
- HK Grotesk font files vendored locally
