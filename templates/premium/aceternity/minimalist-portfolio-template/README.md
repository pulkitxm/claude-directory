...
- **Responsive layout** - one tweet column on mobile, two on tablet, three on laptop, and four on wide desktop
...
Part of the [Aceternity templates](../../README.md) collection. Browse [all templates](../../../../README.md).
