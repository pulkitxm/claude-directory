...
Pixel-faithful clone of the Aceternity UI "Playful Marketing" template, a modern five-page SaaS marketing website for interview recording and feedback management products. The design pairs a clean white background with a teal-green brand color (#25A18E), a subtle dot-grid background pattern, generously rounded sections, and teal gradient calls to action. It is built with vanilla HTML, CSS, and JavaScript, with no framework or build step and all assets vendored locally.
...
Part of the [Aceternity](../) premium templates inside the [Templates](../../) collection.
