# Nodus Agent Template - Aceternity Agentic-Workflow Landing Page Clone
...
This is a plain static site with no build or dependencies. Serve the folder over HTTP so the vendored fonts, images, and stylesheets load correctly:
...
[Aceternity UI Nodus Agent Template](https://ui.aceternity.com/template-preview/nodus-agent-template)

Part of the [templates](../../../) collection.
