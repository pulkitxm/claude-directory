...
| `pricing.html` | Pricing: 4 periods and FAQ accordion |
| `sign-in.html` | Sign In: email/password and OAuth buttons |
| `sign-up.html` | Sign Up: registration form and OAuth buttons |
...
- **Pricing periods**: monthly, quarterly, yearly, and lifetime plans.
...
Part of the [Lexington Themes](../../README.md) collection in the [Templates](../../../README.md) gallery.
